        ...
        <div class="row g-4">
                ...
                <div class="card-custom p-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <small class="text-muted" style="font-size: 10px;">Hệ thống sẽ tự động cộng % này vào mỗi hóa đơn.</small>
                        </div>
                        <div class="col-md-8">
            ...
            <div class="col-lg-4">
                <div class="card-custom p-4 text-center h-100">
                    ...
                    <p class="text-muted text-start" style="font-size: 11px;">Logo này sẽ xuất hiện trên màn hình quét QR của khách hàng và trên Hóa đơn in ra.</p>
