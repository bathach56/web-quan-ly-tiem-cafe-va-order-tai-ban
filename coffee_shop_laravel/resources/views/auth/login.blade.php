...
<body>
    ...
    <div class="login-card animate__animated animate__fadeInUp">
        ...
        <form action="{{ route('login.process') }}" method="POST" id="loginForm">
            ...
            <button type="submit" class="btn btn-amber w-100 mb-3 shadow-lg" id="loginBtn">
            ...
            <div class="position-relative text-center my-4">
                <hr class="text-stone-600 opacity-25">
                <span class="position-absolute top-50 translate-middle px-3 text-stone-500 small fw-bold" style="background: var(--bg-dark); letter-spacing: 1px;">HOẶC</span>
            </div>

            <a href="{{ route('auth.google.redirect') }}" class="btn-google w-100">
